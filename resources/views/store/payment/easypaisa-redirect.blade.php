...
<head>
    ...
    <style>
        ...
        .logo { color: #2e7d32; font-size: 28px; font-weight: bold; margin-bottom: 16px; }
        p { color: #555; margin-bottom: 20px; }
        .spinner { border: 4px solid #f3f3f3; border-top: 4px solid #2e7d32;
...
<body>
    <div class="card">
        ...
        <p>Please wait while we redirect you to EasyPaisa payment page...</p>
    </div>
