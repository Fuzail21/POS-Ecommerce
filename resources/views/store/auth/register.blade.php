...
<body class="bg-gray-100 dark:bg-gray-900 min-h-screen flex items-center justify-center">
    ...
    <div class="w-full max-w-md bg-white dark:bg-gray-800 p-8 rounded-lg shadow-xl">
        ...
        <div class="mb-6 text-center">
            <h3 class="text-3xl font-extrabold text-gray-900 dark:text-white leading-tight">Create Account</h3>
            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Join us to start shopping</p>
        </div>
