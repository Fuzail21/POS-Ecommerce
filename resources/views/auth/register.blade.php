...
<body class="bg-gray-100 dark:bg-gray-900 min-h-screen flex items-center justify-center">
    ...
    <div class="w-full max-w-md bg-white dark:bg-gray-800 p-8 rounded-lg shadow-xl transform transition duration-500 hover:scale-105">
        ...
        <div class="mb-6 text-center">
            <h2 class="text-4xl font-extrabold text-gray-900 dark:text-white leading-tight">Join Us!</h2>
            <p class="mt-2 text-md text-gray-600 dark:text-gray-400">Create your new account</p>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="flex items-center justify-between mb-6">
                ...
                <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 px-6 rounded-md transition duration-200 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800">
                    Register
                </button>
            </div>
