...
<body class="bg-gray-100 dark:bg-gray-900 min-h-screen flex items-center justify-center">
    ...
    <div class="w-full max-w-md bg-white dark:bg-gray-800 p-8 rounded-lg shadow-xl transform transition duration-500 hover:scale-105">
        ...
        <div class="mb-6 text-center">
            <h2 class="text-4xl font-extrabold text-gray-900 dark:text-white leading-tight">New Password</h2>
            <p class="mt-2 text-md text-gray-600 dark:text-gray-400">Set your new password below</p>
        </div>
