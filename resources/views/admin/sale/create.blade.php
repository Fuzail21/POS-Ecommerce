...
document.addEventListener('DOMContentLoaded', () => {
    ...
    amountPaidInput.addEventListener('input', () => {
        ...
        const label = balance >= 0 ? 'Change: $' : 'Balance: $';
        balanceDisplay.value = label + Math.abs(balance).toFixed(2);
        document.getElementById('balance_due_raw').value = balance.toFixed(2); // store raw number
    });
